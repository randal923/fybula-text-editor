...
import 'package:zefyrka/src/fybula_icons.dart';
...
class _LinkStyleButtonState extends State<LinkStyleButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return ZIconButton(
      ...
      size: 32,
      icon: Icon(
        widget.icon ?? FybulaIcons.link,
        size: 18,
        color: isEnabled ? Colors.white : Color(0xff818181),
      ),
    ...
    return ZefyrToolbar(key: key, children: [
      ...
      Visibility(
        ...
        child: ToggleStyleButton(
          ...
          icon: FybulaIcons.text_underline,
          controller: controller,
        ),
      ),
      SizedBox(width: 1),
